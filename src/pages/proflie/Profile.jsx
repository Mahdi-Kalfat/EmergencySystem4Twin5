...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    if (userData) {
      setUser({
        ...
        cityState: userData.cityState || "Arizona, United States", // Default value
        postalCode: userData.postalCode || "ERT 2489", // Default value
        taxId: userData.taxId || "AS4568384", // Default value
      });
    }
  }, []);
  ...
  return (
    <div className={darkMode ? "dark bg-gray-900" : ""}>
      ...
      {/* Modals */}
      {/* Include Profile Info Modal */}
      {/* Include Profile Address Modal */}
    </div>
  );
};
