...
const SideBar = ({ sidebarToggle, page }) => {
  ...
  return (
    <aside
      ...
      onClick={() => sidebarToggle && setSelected(false)}
    >
      {/* SIDEBAR HEADER */}
      <div
            ...
            <ul className="mb-6 flex flex-col gap-4">
              ...
              <li>
                <a
                  ...
                  className={`menu-item group ${
                    selected === 'Calendar' && page === 'calendar' ? 'menu-item-active' : 'menu-item-inactive'
                  }`}
                >
                  <svg
                    className={`${
                      selected === 'Calendar' && page === 'calendar' ? 'menu-item-icon-active' : 'menu-item-icon-inactive'
                    }`}
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
                  ...
                  <span className={`menu-item-text ${sidebarToggle ? 'lg:hidden' : ''}`}>Calendar</span>
                </a>
              </li>
              {/* Menu Item Calendar */}
            </ul>
